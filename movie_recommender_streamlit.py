...
movies['year_of_publication'] = movies['title'].str.extract(r'(\d{4})').astype(float)
movies['year_of_publication'].fillna(0000, inplace=True)
movies['year_of_publication'] = movies['year_of_publication'].astype(int)
            ...
            try:
                ...
                if not similar_movies_df.empty:
                    ...
                    if len(similar_movies_100) > 1:
                        ...
                        selected_movie = st.selectbox('Select a movie:', similar_movies_100['title'].tolist(), key=f'selected_movie_{movie_select_count}')
                        popular_ranking = popular_ranking_outer()
                        st.write(":popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn::popcorn:")
